...
static int G__E_fieldDict_226_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   E_field *p;
...
static int G__E_fieldDict_226_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__E_fieldDict_226_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__E_fieldDict_226_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableE_fieldDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<std::bidirectional_iterator_tag,TObject*,std::ptrdiff_t,const TObject**,const TObject*&>",117,G__get_linked_tagnum(&G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*,std::ptrdiff_t,const TObject**,const TObject*&>",117,G__get_linked_tagnum(&G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*>",117,G__get_linked_tagnum(&G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*,long>",117,G__get_linked_tagnum(&G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("iterator<bidirectional_iterator_tag,TObject*,long,const TObject**>",117,G__get_linked_tagnum(&G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR),0,-1);
   G__setnewtype(-1,NULL,0);
...
static void G__setup_memfuncE_field(void) {
   ...
   // automatic default constructor
   G__memfunc_setup("E_field", 680, G__E_fieldDict_226_0_1, (int) ('i'), G__get_linked_tagnum(&G__E_fieldDictLN_E_field), -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic copy constructor
   G__memfunc_setup("E_field", 680, G__E_fieldDict_226_0_2, (int) ('i'), G__get_linked_tagnum(&G__E_fieldDictLN_E_field), -1, 0, 1, 1, 1, 0, "u 'E_field' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~E_field", 806, G__E_fieldDict_226_0_3, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__E_fieldDict_226_0_4, (int) ('u'), G__get_linked_tagnum(&G__E_fieldDictLN_E_field), -1, 1, 1, 1, 1, 0, "u 'E_field' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR = { "iterator<bidirectional_iterator_tag,TObject*,long,const TObject**,const TObject*&>" , 115 , -1 };
...
extern "C" void G__cpp_reset_tagtableE_fieldDict() {
  ...
  G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableE_fieldDict() {
   ...
   G__get_linked_tagnum_fwd(&G__E_fieldDictLN_iteratorlEbidirectional_iterator_tagcOTObjectmUcOlongcOconstsPTObjectmUmUcOconstsPTObjectmUaNgR);
