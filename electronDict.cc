...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::electron*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("electron", ::electron::Class_Version(), "./electron.h", 21,
...
/* electron */
static int G__electronDict_215_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   electron* p = NULL;
...
static int G__electronDict_215_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      {
...
static int G__electronDict_215_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__electronDict_215_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letdouble(result7, 100, (double) ((electron*) G__getstructoffset())->mean_free_path());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) ((electron*) G__getstructoffset())->status());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) electron::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) electron::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) electron::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      electron::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__electronDict_215_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const electron*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__electronDict_215_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__electronDict_215_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__electronDict_215_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) electron::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) electron::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) electron::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__electronDict_215_0_17(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__electronDict_215_0_23(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__electronDict_215_0_24(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static void G__setup_memvarelectron(void) {
   ...
   G__memvar_setup((void*)0,85,0,0,G__get_linked_tagnum(&G__electronDictLN_TF1),-1,-1,4,"fdist=",0,(char*)NULL);
...
static void G__setup_memfuncelectron(void) {
   ...
   G__memfunc_setup("electron",860,G__electronDict_215_0_1, 105, G__get_linked_tagnum(&G__electronDictLN_electron), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("operator=",937,G__electronDict_215_0_2, 117, G__get_linked_tagnum(&G__electronDictLN_electron), -1, 1, 1, 1, 1, 0, "u 'electron' - 11 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("step",444,G__electronDict_215_0_3, 121, -1, -1, 0, 1, 1, 1, 0, "u 'vector<E_field,allocator<E_field> >' 'vector<E_field>' 10 - -", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("mean_free_path",1454,G__electronDict_215_0_4, 100, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("status",676,G__electronDict_215_0_5, 105, -1, -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__electronDict_215_0_6, 85, G__get_linked_tagnum(&G__electronDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&electron::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__electronDict_215_0_7, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&electron::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__electronDict_215_0_8, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&electron::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__electronDict_215_0_9, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&electron::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__electronDict_215_0_10, 85, G__get_linked_tagnum(&G__electronDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__electronDict_215_0_11, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__electronDict_215_0_12, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__electronDict_215_0_13, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__electronDict_215_0_14, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&electron::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__electronDict_215_0_15, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&electron::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__electronDict_215_0_16, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&electron::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__electronDict_215_0_17, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&electron::DeclFileLine) ), 0);
   G__memfunc_setup("collision_time",1498,(G__InterfaceMethod) NULL, 100, -1, -1, 0, 0, 5, 4, 0, "", (char*)NULL, (void*) NULL, 0);
   ...
   // automatic copy constructor
   G__memfunc_setup("electron", 860, G__electronDict_215_0_23, (int) ('i'), G__get_linked_tagnum(&G__electronDictLN_electron), -1, 0, 1, 1, 1, 0, "u 'electron' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~electron", 986, G__electronDict_215_0_24, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__electronDictLN_TF1 = { "TF1" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableelectronDict() {
  ...
  G__electronDictLN_TF1.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableelectronDict() {
   ...
   G__get_linked_tagnum_fwd(&G__electronDictLN_TF1);
