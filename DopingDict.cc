//
// File generated by rootcint at Thu Oct 26 13:44:52 2017
...
namespace ROOTDict {
   ...
   static ROOT::TGenericClassInfo *GenerateInitInstanceLocal(const ::Doping*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("Doping", ::Doping::Class_Version(), "./Doping.h", 22,
...
/* Doping */
static int G__DopingDict_190_0_1(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   Doping* p = NULL;
...
static int G__DopingDict_190_0_2(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) Doping::Class());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DopingDict_190_0_3(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Doping::Class_Name());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DopingDict_190_0_4(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 115, (long) Doping::Class_Version());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DopingDict_190_0_5(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      Doping::Dictionary();
      G__setnull(result7);
   return(1 || funcname || hash || result7 || libp) ;
...
static int G__DopingDict_190_0_6(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 85, (long) ((const Doping*) G__getstructoffset())->IsA());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DopingDict_190_0_7(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DopingDict_190_0_8(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DopingDict_190_0_9(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DopingDict_190_0_10(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Doping::DeclFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DopingDict_190_0_11(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 105, (long) Doping::ImplFileLine());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DopingDict_190_0_12(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
      G__letint(result7, 67, (long) Doping::ImplFileName());
   return(1 || funcname || hash || result7 || libp) ;
}

static int G__DopingDict_190_0_13(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
static int G__DopingDict_190_0_14(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
...
static int G__DopingDict_190_0_15(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
   char* gvp = (char*) G__getgvp();
...
static int G__DopingDict_190_0_16(G__value* result7, G__CONST char* funcname, struct G__param* libp, int hash)
{
...
extern "C" void G__cpp_setup_typetableDopingDict() {
   ...
   G__setnewtype(-1,NULL,0);
   G__search_typename2("vector<doping_value>",117,G__get_linked_tagnum(&G__DopingDictLN_vectorlEdoping_valuecOallocatorlEdoping_valuegRsPgR),0,-1);
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<const_iterator>",117,G__get_linked_tagnum(&G__DopingDictLN_reverse_iteratorlEvectorlEdoping_valuecOallocatorlEdoping_valuegRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__DopingDictLN_vectorlEdoping_valuecOallocatorlEdoping_valuegRsPgR));
   G__setnewtype(-1,NULL,0);
   G__search_typename2("reverse_iterator<iterator>",117,G__get_linked_tagnum(&G__DopingDictLN_reverse_iteratorlEvectorlEdoping_valuecOallocatorlEdoping_valuegRsPgRcLcLiteratorgR),0,G__get_linked_tagnum(&G__DopingDictLN_vectorlEdoping_valuecOallocatorlEdoping_valuegRsPgR));
   G__setnewtype(-1,NULL,0);
}
...
static void G__setup_memfuncDoping(void) {
   ...
   G__memfunc_setup("Doping",609,G__DopingDict_190_0_1, 105, G__get_linked_tagnum(&G__DopingDictLN_Doping), -1, 0, 0, 1, 1, 0, "", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("Class",502,G__DopingDict_190_0_2, 85, G__get_linked_tagnum(&G__DopingDictLN_TClass), -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (TClass* (*)())(&Doping::Class) ), 0);
   G__memfunc_setup("Class_Name",982,G__DopingDict_190_0_3, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Doping::Class_Name) ), 0);
   G__memfunc_setup("Class_Version",1339,G__DopingDict_190_0_4, 115, -1, G__defined_typename("Version_t"), 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (Version_t (*)())(&Doping::Class_Version) ), 0);
   G__memfunc_setup("Dictionary",1046,G__DopingDict_190_0_5, 121, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (void (*)())(&Doping::Dictionary) ), 0);
   G__memfunc_setup("IsA",253,G__DopingDict_190_0_6, 85, G__get_linked_tagnum(&G__DopingDictLN_TClass), -1, 0, 0, 1, 1, 8, "", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("ShowMembers",1132,G__DopingDict_190_0_7, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TMemberInspector' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("Streamer",835,G__DopingDict_190_0_8, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - -", (char*)NULL, (void*) NULL, 1);
   G__memfunc_setup("StreamerNVirtual",1656,G__DopingDict_190_0_9, 121, -1, -1, 0, 1, 1, 1, 0, "u 'TBuffer' - 1 - ClassDef_StreamerNVirtual_b", (char*)NULL, (void*) NULL, 0);
   G__memfunc_setup("DeclFileName",1145,G__DopingDict_190_0_10, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Doping::DeclFileName) ), 0);
   G__memfunc_setup("ImplFileLine",1178,G__DopingDict_190_0_11, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Doping::ImplFileLine) ), 0);
   G__memfunc_setup("ImplFileName",1171,G__DopingDict_190_0_12, 67, -1, -1, 0, 0, 3, 1, 1, "", (char*)NULL, (void*) G__func2void( (const char* (*)())(&Doping::ImplFileName) ), 0);
   G__memfunc_setup("DeclFileLine",1152,G__DopingDict_190_0_13, 105, -1, -1, 0, 0, 3, 1, 0, "", (char*)NULL, (void*) G__func2void( (int (*)())(&Doping::DeclFileLine) ), 0);
   // automatic copy constructor
   G__memfunc_setup("Doping", 609, G__DopingDict_190_0_14, (int) ('i'), G__get_linked_tagnum(&G__DopingDictLN_Doping), -1, 0, 1, 1, 1, 0, "u 'Doping' - 11 - -", (char*) NULL, (void*) NULL, 0);
   // automatic destructor
   G__memfunc_setup("~Doping", 735, G__DopingDict_190_0_15, (int) ('y'), -1, -1, 0, 0, 1, 1, 0, "", (char*) NULL, (void*) NULL, 0);
   // automatic assignment operator
   G__memfunc_setup("operator=", 937, G__DopingDict_190_0_16, (int) ('u'), G__get_linked_tagnum(&G__DopingDictLN_Doping), -1, 1, 1, 1, 1, 0, "u 'Doping' - 11 - -", (char*) NULL, (void*) NULL, 0);
...
G__linked_taginfo G__DopingDictLN_vectorlEdoping_valuecOallocatorlEdoping_valuegRsPgR = { "vector<doping_value,allocator<doping_value> >" , 99 , -1 };
G__linked_taginfo G__DopingDictLN_reverse_iteratorlEvectorlEdoping_valuecOallocatorlEdoping_valuegRsPgRcLcLiteratorgR = { "reverse_iterator<vector<doping_value,allocator<doping_value> >::iterator>" , 99 , -1 };
...
extern "C" void G__cpp_reset_tagtableDopingDict() {
  ...
  G__DopingDictLN_vectorlEdoping_valuecOallocatorlEdoping_valuegRsPgR.tagnum = -1 ;
  G__DopingDictLN_reverse_iteratorlEvectorlEdoping_valuecOallocatorlEdoping_valuegRsPgRcLcLiteratorgR.tagnum = -1 ;
...
extern "C" void G__cpp_setup_tagtableDopingDict() {
   ...
   G__get_linked_tagnum_fwd(&G__DopingDictLN_vectorlEdoping_valuecOallocatorlEdoping_valuegRsPgR);
   G__get_linked_tagnum_fwd(&G__DopingDictLN_reverse_iteratorlEvectorlEdoping_valuecOallocatorlEdoping_valuegRsPgRcLcLiteratorgR);
